...
N_list, M_list, C_list, P_list, D_list = read_testcases_from_file(file_path)

# In thử một số kết quả
print("N_list:", N_list)
print("M_list:", M_list)
print("C_list[0]:", C_list[2])  # In giá trị ma trận C của testcase đầu tiên
print("P_list[0]:", P_list[2])  # In giá trị P của testcase đầu tiên
print("D_list[0]:", D_list[3])  # In giá trị D của testcase đầu tiên
